...
import { categories, normalizeToolUrl, type Tool } from "@/data/tools";
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-12">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-balance text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">{tool.name}</h1>
